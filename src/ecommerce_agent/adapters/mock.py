...
class MockCommerceAdapter:
    def __init__(self) -> None:
        self.products = [
            Product(id="p-100", name="企业级智能客服套装", price=Decimal("1999.00"), status="on_sale", stock=42, source="mock"),
            Product(id="p-200", name="仓储管理终端", price=Decimal("899.00"), status="on_sale", stock=18, source="mock"),
        ]
        self.orders = [
            Order(id="o-100", order_sn="MOCK20260720001", status="paid", amount=Decimal("1999.00"), source="mock"),
        ]

    def capabilities(self) -> dict[str, bool]:
        return {"product.search": True, "product.get": True, "order.list": True, "order.get": True, "order.ship": False}
